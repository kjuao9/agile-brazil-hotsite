...
class ProgramSessions extends React.Component {
  render() {
    ...
    const ApprovedSessions = props => (
      <ul class="approvedSessions">
        <li>Something</li>
      </ul>
    );
  ...
  render() {
    ...
    const Introduction = () => (
      <section className="program--introduction">
        <h1 className="program--introduction-title"><translate>How do we build the the program</translate> <a href="http://agilebrazil.com" target="_blank">#AgileBR</a></h1>
